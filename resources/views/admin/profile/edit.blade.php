...
@push('css_or_js')
<link href="{{asset('public/back-end/css/croppie.css')}}" rel="stylesheet">
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <h2 class="col-sm mb-2 mb-sm-0 h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                    <img width="20" src="{{asset('public/back-end/img/profile_setting.png')}}" alt="">
                ...
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <div class="profile-cover">
                            @php($shop_banners = $shop_banner ? asset('public/storage/shop/'.$shop_banner) : 'https://images.pexels.com/photos/866398/pexels-photo-866398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
