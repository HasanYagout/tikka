...
{{--                                <img src="{{asset('back-end/img/business_analytics.png')}}" alt="">{{\App\CPU\translate('business_analytics')}}</h4>--}}
{{--                        </div>--}}
...
{{--                        <img width="20" class="mb-1" src="{{asset('back-end/img/admin-wallet.png')}}" alt="">--}}
...
{{--                                <div class="col-md-6">--}}
{{--                                    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">--}}
{{--                                        <img src="{{asset('back-end/img/earning_statictics.png')}}" alt="">--}}
...
@push('script')
    <script src="{{asset('back-end')}}/vendor/chart.js/dist/Chart.min.js"></script>
    <script src="{{asset('back-end')}}/vendor/chart.js.extensions/chartjs-extensions.js"></script>
    <script
        src="{{asset('back-end')}}/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
@endpush
