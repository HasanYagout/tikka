    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img width="20" src="{{asset('public/back-end/img/earning_report.png')}}" alt="">
        ...
        <!-- Inlile Menu -->
        @include('admin.report.earning-report-inline-menu')
        <!-- End Inlile Menu -->
        ...
        <div class="card mb-2">
         ...
         <div class="store-report-content mb-2">
            <div class="left-content">
                ...
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/total-earning.svg')}}" alt="">
                    <div class="info">
