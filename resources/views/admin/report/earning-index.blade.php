            ...
            <div class="card-body">
                <div class="media align-items-center">
                    ...
                    <div class="avatar avatar-xl avatar-4by3">
                        <img class="avatar-img" src="{{asset('back-end')}}/svg/illustrations/earnings.png"
...
@push('script_2')
    ...
    <script
        src="{{asset('back-end')}}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
    <script src="{{asset('back-end')}}/js/hs.chartjs-matrix.js"></script>
