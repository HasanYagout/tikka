    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2 align-items-center">
                <img width="20" src="{{asset('public/back-end/img/seller_sale.png')}}" alt="">
        ...
        <!-- Inlile Menu -->
        @include('admin.report.product-report-inline-menu')
        <!-- End Inlile Menu -->
        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/cart.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/products.svg')}}" alt="">
                    <div class="info">
                        <h4 class="subtitle">
                            {{ $total_product_sale }}
                        </h4>
                ...
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/stores.svg')}}" alt="">
                    <div class="info">
                        <h4 class="subtitle">
...
@push('script')
    ...
    <!-- Apex Charts -->
    <script src="{{ asset('public/back-end/js/apexcharts.js') }}"></script>
    <!-- Apex Charts -->
