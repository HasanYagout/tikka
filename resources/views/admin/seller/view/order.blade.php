                ...
                <div class="row pt-2">
                    <div class="col-md-12">
                        <div class="card w-100">
                            ...
                            <!-- Card -->
                            @php($pending_order = App\Models\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$seller->id])->where('order_status','pending')->where('order_type','default_type')->get())
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @php($delivered_order = App\Models\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$seller->id])->where('order_status','delivered')->where('order_type','default_type')->get())
                                    <div class="col-md-4 mb-3 mb-md-0">
                                    ...
                                    @php($total_order = App\Models\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$seller->id])->where('order_type','default_type')->get())
                                    <div class="col-md-4">
