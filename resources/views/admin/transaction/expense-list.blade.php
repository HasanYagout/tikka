    ...
    <div class="content container-fluid ">
        ...
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img width="20" src="{{asset('/back-end/img/order_report.png')}}" alt="">
         ...
         <div class="store-report-content mb-2">
            <div class="left-content expense--content">
                <div class="left-content-card">
                    <img src="{{asset('/back-end/img/expense.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{asset('/back-end/img/free-delivery.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{asset('/back-end/img/coupon-discount.svg')}}" alt="">
                    <div class="info">
