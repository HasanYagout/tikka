...
@section('content')
    <div class="content container-fluid ">
        ...
        <!-- Inlile Menu -->
        @include('admin.report.transaction-report-inline-menu')
        <!-- End Inlile Menu -->
         ...
         <div class="store-report-content mb-2">
            <div class="left-content expense--content">
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/expense.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/free-delivery.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{asset('public/back-end/img/coupon-discount.svg')}}" alt="">
                    <div class="info">
