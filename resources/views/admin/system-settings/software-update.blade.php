    ...
    <div class="content container-fluid">
        ...
        <div class="mb-4 pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="{{asset('/back-end/img/system-setting.png')}}" alt="">
                ...
                <div class="card">
                    <div class="border-bottom px-4 py-3">
                        <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                            <img width="20" src="{{asset('/back-end/img/environment.png')}}" alt="">
                            ...
                            <span class="ml-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{\App\CPU\translate('this_module_will_run_for_updates_after_version_13.1')}}">
                                <img class="info-img w-200" src="{{asset('/back-end/img/info-circle.svg')}}" alt="img">
                            </span>
                        </h5>
                    </div>
