                ...
                <div class="row g-2">
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            ...
                            <img src="{{ asset('public/back-end/img/aw.png') }}" width="40" class="business-analytics__img" alt="">
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            ...
                            <img src="{{ asset('public/back-end/img/pw.png') }}" width="40" class="business-analytics__img" alt="">
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            ...
                            <img src="{{ asset('public/back-end/img/withdraw.png') }}" width="40" class="business-analytics__img" alt="">
                        </div>
