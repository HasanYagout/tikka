                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    <img src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$detail->product_all_status['thumbnail']}}" onerror="this.src='{{asset('back-end/img/160x160/img2.jpg')}}'" class="avatar avatar-60 rounded" alt="">
                            ...
                            <div class="media flex-wrap gap-3">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    ...
                                    <span class="title-color">
                                        <strong>{{\App\Models\Order::where('order_type','POS')->where('customer_id',$order['customer_id'])->count()}} </strong>{{\App\CPU\translate('orders')}}
                                    </span>
