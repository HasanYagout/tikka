        ...
        <div class="row gy-3" id="printableArea">
                                                        ...
                                                        <div class="modal-body">
                                                            @if($detail->digital_file_after_sell)
                                                                <div class="mb-4">
                                                                    ...
                                                                    <a href="{{ asset('public/storage/product/digital-product/'.$detail->digital_file_after_sell) }}"
            ...
            <div class="col-lg-4 col-xl-3 d-flex flex-column gap-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="d-flex align-items-start gap-2">
                                    ...
                                    <img src="{{asset('public/back-end/img/location.png')}}" alt="">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-4 d-flex gap-2">
                            <img src="{{asset('public/back-end/img/shop-information.png')}}" alt="">
                            ...
                            @else
                                @if(!empty($order->seller->shop))
                                    ...
                                    <div class="media-body d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex align-items-start gap-2">
                                            <img src="{{asset('public/back-end/img/location.png')}}" class="mt-1" alt="">
