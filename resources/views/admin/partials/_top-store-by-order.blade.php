...
<div class="card-header gap-10">
    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
        <img src="{{asset('public/back-end/img/top-selling-store.png')}}" alt="">
                ...
                @if(isset($shop))
                    <a href="{{route('admin.sellers.view',$item['seller_id'])}}" class="grid-item">
                        <div class="d-flex align-items-center gap-10">
                            <img onerror="this.src='{{asset('public/back-end/img/160x160/img1.jpg')}}'"
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <img src="{{asset('public/back-end/img/love.png')}}" alt="">
                        </div>
                    </a>
                @endif
            @endforeach
