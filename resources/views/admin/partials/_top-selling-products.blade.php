...
<div class="card-header gap-10">
    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
        <img width="20" src="{{asset('public/back-end/img/top-selling-product.png')}}" alt="">
                    ...
                    <div class="cursor-pointer"
                        ...
                        <div class="grid-item px-0 bg-transparent">
                            <div class="d-flex gap-10">
                                <img src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$item->product['thumbnail']}}" class="avatar avatar-lg rounded avatar-bordered" onerror="this.src='{{asset('public/back-end/img/160x160/img2.jpg')}}'" alt="{{$item->product->name}} image">
