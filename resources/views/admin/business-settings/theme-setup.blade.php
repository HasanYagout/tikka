...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{ asset('public/back-end/vendor/swiper/swiper-bundle.min.css')}}"/>
@endpush
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4 pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="{{asset('public/back-end/img/teheme-setup.png')}}" alt="">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder">
                ...
                <div class="ripple-animation" data-toggle="modal" data-target="#settingModal">
                    <img src="{{asset('public/back-end/img/icons/info.svg')}}" class="svg" alt="">
                </div>
            </div>
                                ...
                                <div class="col-12">
                                    <div class="swiper mySwiper pb-3">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                    <img src="{{asset('public/back-end/img/slider-3.png')}}"
                                                         loading="lazy"
                                                         alt="" class="dark-support rounded mb-4">
                                                    <p>
        ...
        <!-- Inlile Menu -->
        @include('admin.business-settings.system-settings-inline-menu')
        <!-- End Inlile Menu -->
                        ...
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            ...
                            <div class="mt-5 card px-3 py-2 d--none" id="progress-bar">
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <div class="">
                                        <img width="24" src="{{asset('public/back-end/img/zip.png')}}" alt="">
                                    </div>
        ...
        <div class="row g-1 g-sm-2">
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                @if($key!='default' && theme_root_path() != $key)
                                    <button class="text-danger bg-transparent p-0 border-0" data-toggle="modal"
                                            ...
                                            src="{{asset('public/back-end/img/icons/delete.svg')}}" class="svg"
                                            alt=""></button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="{{asset('public/back-end/img/delete.png')}}"
                                                             alt="">
                                                    </div>
                                ...
                                @if(theme_root_path() == $key)
                                    <button class="c1 bg-transparent p-0 border-0"><img
                                            src="{{asset('public/back-end/img/icons/check.svg')}}" class="svg"
                                            alt=""></button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="{{asset('public/back-end/img/shift.png')}}"
                                                             alt="">
                                                    </div>
            ...
            @include('admin.business-settings.partials.theme-activate-modal')
        </div>
    </div>
...
@push('script')
    <script src="{{ asset('public/back-end/vendor/swiper/swiper-bundle.min.js')}}"></script>
