    ...
    <div class="content container-fluid">
        ...
        <div class="pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="{{asset('/back-end/img/business-setup.png')}}" alt="">
            ...
            <div class="row">
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2">
                                <img src="{{asset('/back-end/img/website-color.png')}}" alt="">
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/back-end/img/header-logo.png')}}" alt="">
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/back-end/img/footer-logo.png')}}" alt="">
