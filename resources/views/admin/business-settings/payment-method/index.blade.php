    ...
    <div class="content container-fluid">
        ...
        <div class="mb-4 pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="{{asset('public/back-end/img/3rd-party.png')}}" alt="">
        ...
        <!-- Inlile Menu -->
    @include('admin.business-settings.third-party-inline-menu')
    <!-- End Inlile Menu -->
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img src="{{asset('public/back-end/img/ssl-commerz.png')}}" alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.business-settings.payment-method.update',['paypal'])}}"
                            ...
                            @if(isset($config))
                                <center class="mb-3">
                                    <img src="{{asset('public/back-end/img/paypal.png')}}" alt="">
                                </center>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.business-settings.payment-method.update',['stripe'])}}"
                            ...
                            @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img src="{{asset('public/back-end/img/stripe.png')}}" alt="">
                                </center>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.business-settings.payment-method.update',['razor_pay'])}}"
                            ...
                            @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img src="{{asset('public/back-end/img/razorpay.png')}}" alt="">
                                </center>
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/senangpay.png')}}"
                                         alt="">
                                </center>
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/paytabs.png')}}" alt="">
                                </center>
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/paystack.png')}}" alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/paymob.png')}}" alt="">
                                </center>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/fawry.svg')}}" alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/mercado.svg')}}" alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/liqpay4.png')}}" alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/fluterwave.png')}}"
                                         alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/paytm.png')}}" alt="">
                                </center>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if(isset($config))
                                ...
                                <center class="mb-3">
                                    <img height="60" src="{{asset('public/back-end/img/bkash.png')}}" alt="">
                                </center>
