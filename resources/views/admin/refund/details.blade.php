...
<div class="content container-fluid">
    @php($order = App\Models\Order::find($refund->order_id))
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            <img width="20" src="{{asset('/back-end/img/refund_transaction.png')}}" alt="">
                ...
                <div class="card-body">
                    <div class="row gy-2">
                        <div class="col-sm-4 col-md-4 col-lg-2">
                            <div >
                                <img onerror="this.src='{{asset('front-end/img/image-place-holder.png')}}'"
