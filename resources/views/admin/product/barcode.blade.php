...
@push('css_or_js')
    <link rel="stylesheet" href="{{ asset('back-end') }}/css/barcode.css" />
@endpush
@section('content')
    ...
    <div id="printarea" class="show-div pb-5">
        ...
        <div class="item style24">
            <span
                class="barcode_site text-capitalize">{{ \App\Models\BusinessSetting::where('type', 'company_name')->first()->value }}</span>
