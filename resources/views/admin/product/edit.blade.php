...
@push('css_or_js')
    <link href="{{asset('back-end/css/tags-input.min.css')}}" rel="stylesheet">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-12 mt-2 mb-2">
                                    <div class="customer_choice_options" id="customer_choice_options">
                                        @include('admin.product.partials._choices',['choice_no'=>json_decode($product['attributes']),'choice_options'=>json_decode($product['choice_options'],true)])
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-12 sku_combination table-responsive form-group" id="sku_combination">
                                    @include('admin.product.partials._edit_sku_combinations',['combinations'=>json_decode($product['variation'],true)])
                                </div>
                                    ...
                                    <div class="__coba-aspect">
                                        <div class="row g-2" id="meta_img">
                                            <div class="col-sm-6 col-md-12 col-lg-6">
                                                <img class="w-100" height="auto" onerror="this.src='{{asset('front-end/img/image-place-holder.png')}}'"
...
@push('script_2')
    ...
    <script src="{{asset('back-end/js/spartan-multi-image-picker.js')}}"></script>
    <script>
        var colors = {{ count($product->colors) }};
        var imageCount = {{10-count(json_decode($product->images))}};
        var thumbnail = '{{\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$product->thumbnail??asset('back-end/img/400x400/img2.jpg')}}';
        $(function () {
            if ( imageCount > 0) {
                $("#coba").spartanMultiImagePicker({
                    ...
                    maxFileSize: '',
                    placeholderImage: {
                        image: '{{asset('back-end/img/400x400/img2.jpg')}}',
                        width: '100%',
                    },
            ...
            $.each(colors, function(key, value){
                ...
                if(in_array_image === -1) {
                    let html = ` <div class='col-6 col-md-6'> <label style='border: 2px dashed #ddd; border-radius: 3px; cursor: pointer; text-align: center; overflow: hidden; padding: 5px; margin-top: 5px; margin-bottom : 5px; position : relative; display: flex; align-items: center; margin: auto; justify-content: center; flex-direction: column;'>
                            ...
                            <img src="{{ asset('back-end/img/400x400/img2.jpg') }}" style="object-fit: cover;aspect-ratio:1"  alt="public/img">
                          </label> </div>`;
