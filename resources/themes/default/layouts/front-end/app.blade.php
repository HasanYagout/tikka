...
<head>
    ...
    <link rel="stylesheet" media="screen"
          href="{{asset('front-end')}}/vendor/simplebar/dist/simplebar.min.css"/>
    <link rel="stylesheet" media="screen"
          href="{{asset('front-end')}}/vendor/tiny-slider/dist/tiny-slider.css"/>
    <link rel="stylesheet" media="screen"
          href="{{asset('front-end')}}/vendor/drift-zoom/dist/drift-basic.min.css"/>
    <link rel="stylesheet" media="screen"
          href="{{asset('front-end')}}/vendor/lightgallery.js/dist/css/lightgallery.min.css"/>
    ...
    <link rel="stylesheet" media="screen" href="{{asset('front-end')}}/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="{{asset('back-end')}}/vendor/icon-set/style.css">
    @stack('css_or_js')

    <link rel="stylesheet" href="{{asset('front-end')}}/css/home.css"/>
    <link rel="stylesheet" href="{{asset('front-end')}}/css/responsive1.css"/>
    ...
    @if(isset($whatsapp['status']) && $whatsapp['status'] == 1 )
        <div class="wa-widget-send-button">
            <a href="https://wa.me/{{ $whatsapp['phone'] }}?text=Hello%20there!" target="_blank">
                <img src="{{asset('front-end/img/whatsapp.svg')}}" class="wa-messenger-svg-whatsapp wh-svg-icon" alt="Chat with us on WhatsApp">
            </a>
        </div>
    @endif
...
<script
    src="{{asset('front-end')}}/vendor/bs-custom-file-input/dist/bs-custom-file-input.min.js"></script>
<script src="{{asset('front-end')}}/vendor/simplebar/dist/simplebar.min.js"></script>
<script src="{{asset('front-end')}}/vendor/tiny-slider/dist/min/tiny-slider.js"></script>
<script src="{{asset('front-end')}}/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>

{{-- light box --}}
<script src="{{asset('public/js/lightbox.min.js')}}"></script>
<script src="{{asset('front-end')}}/vendor/drift-zoom/dist/Drift.min.js"></script>
<script src="{{asset('front-end')}}/vendor/lightgallery.js/dist/js/lightgallery.min.js"></script>
<script src="{{asset('front-end')}}/vendor/lg-video.js/dist/lg-video.min.js"></script>
{{--Toastr--}}
...
<script>
    ...
    img.addEventListener("error", function (event) {
        event.target.src = '{{asset('front-end/img/image-place-holder.png')}}';
        event.onerror = null
    })
