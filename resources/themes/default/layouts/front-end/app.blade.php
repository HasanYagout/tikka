...
<head>
    ...
    <link rel="stylesheet" media="screen"
          href="{{asset('public/front-end/vendor/simplebar/dist/simplebar.min.css')}}"/>
    <link rel="stylesheet" media="screen"
          href="{{asset('public/front-end/vendor/tiny-slider/dist/tiny-slider.css')}}"/>
    <link rel="stylesheet" media="screen"
    ...
    <link rel="stylesheet" media="screen" href="{{asset('public/front-end/css/font-awesome.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('public/front-end/css/home.css')}}"/>
...
<script
    src="{{asset('public/front-end')}}/vendor/bs-custom-file-input/dist/bs-custom-file-input.min.js"></script>
<script src="{{asset('public/front-end')}}/vendor/simplebar/dist/simplebar.min.js"></script>
<script src="{{asset('public/front-end')}}/vendor/tiny-slider/dist/min/tiny-slider.js"></script>
<script src="{{asset('public/front-end')}}/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>

{{-- light box --}}
<script src="{{asset('public/js/lightbox.min.js')}}"></script>
<script src="{{asset('public/front-end')}}/vendor/drift-zoom/dist/Drift.min.js"></script>
