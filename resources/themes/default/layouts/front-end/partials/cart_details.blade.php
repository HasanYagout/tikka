...
@php($cart=\App\Models\Cart::where(['customer_id' => auth('customer')->id()])->get()->groupBy('cart_group_id'))
...
{{--                                                        onerror="this.src='{{asset('front-end/img/image-place-holder.png')}}'"--}}
                                ...
                                <td>
                                    <div>
                                        @php($minimum_order=\App\Models\Product::select('minimum_order_qty')->find($cartItem['product_id']))
