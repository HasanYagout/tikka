            ...
            <section class="col-lg-8">
                ...
                <!-- Shipping methods table-->
                    @if($physical_product_view)
                        ...
                        @php($shipping_addresses=\App\Models\ShippingAddress::where('customer_id',auth('customer')->id())->where('is_billing',0)->get())
                    ...
                    <div style="display: {{$billing_input_by_customer?'':'none'}}">
                        ...
                        @php($billing_addresses=\App\Models\ShippingAddress::where('customer_id',auth('customer')->id())->where('is_billing',1)->get())
                        @if($physical_product_view)
