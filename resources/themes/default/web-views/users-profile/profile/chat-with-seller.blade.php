                                    ...
                                    @foreach($unique_shops as $key=>$shop)
                                        <div class="chat_list @if ($key == 0) btn--primary @endif"
                                            ...
                                            <div class="chat_people" id="chat_people">
                                                <div class="chat_img">
                                                    <img onerror="this.src='{{asset('public/front-end/img/image-place-holder.png')}}'" src="{{ $shop->delivery_man_id ?asset('storage/delivery-man/'.$shop->image) : asset('public/storage/shop/'.$shop->image)}}"
                                                        class="__rounded-10">
                                                </div>
                                                <div class="chat_ib">
                                                ...
                                                @if ($chat->sent_by_seller? $chat->sent_by_seller : $chat->sent_by_delivery_man)
                                                    <div class="incoming_msg">
                                                        <div class="incoming_msg_img"><img
                                                                src="@if($chat->image == 'def.png'){{asset('storage/'.$chat->image)}} @else {{ $shop->delivery_man_id ?asset('storage/delivery-man/'.$last_chat->delivery_man->image) : asset('public/storage/shop/'.$last_chat->shop->image)}}
                                                                @endif"
                                                                alt="sunil"></div>
