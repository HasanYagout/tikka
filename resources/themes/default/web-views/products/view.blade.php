...
@push('css_or_js')
    <meta property="og:image" content="{{asset('public/storage/app/public/company')}}/{{$web_config['web_logo']}}"/>
    <meta property="og:title" content="Products of {{$web_config['name']}} "/>
    <meta property="og:url" content="{{env('APP_URL')}}">
    <meta property="og:description" content="{!! substr($web_config['about']->value,0,100) !!}">

    <meta property="twitter:card" content="{{asset('public/storage/app/public/company')}}/{{$web_config['web_logo']}}"/>
