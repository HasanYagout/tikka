...
@push('css_or_js')
    @if($shop['id'] != 0)
        <meta property="og:image" content="{{asset('public/storage/app/public/shop')}}/{{$shop->image}}"/>
        <meta property="og:title" content="{{ $shop->name}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="og:image" content="{{asset('public/storage/app/public/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="og:title" content="{{ $shop['name']}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
    <meta property="og:description" content="{!! substr($web_config['about']->value,0,100) !!}">
    @if($shop['id'] != 0)
        <meta property="twitter:card" content="{{asset('public/storage/app/public/shop')}}/{{$shop->image}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="twitter:card"
              content="{{asset('public/storage/app/public/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
    ...
    <main class="main-content d-flex flex-column gap-3 py-3">
        <div class="container">
            <div class="rounded ov-hidden mb-3">
                @if($shop['id'] != 0)
                    <div class="store-banner dark-support bg-badge overflow-hidden" data-bg-img="">
                        <img class="w-100" src="{{asset('public/storage/app/public/shop/banner')}}/{{$shop->banner}}"
                    ...
                    <div class="d-flex gap-4 flex-wrap">
                            ...
                            <div class="media gap-3">
                                <div class="avatar rounded store-avatar">
                                    <div class="position-relative">
                                        <img src="{{asset('public/storage/app/public/shop')}}/{{$shop->image}}"
                        ...
                        @else
                            <div class="media gap-3">
                                <div class="avatar rounded store-avatar">
                                    <div class="position-relative">
                                        <img src="{{asset('public/storage/app/public/company')}}/{{$web_config['fav_icon']->value}}"
                                        onerror="this.src='{{theme_asset('assets/img/image-place-holder.png')}}'" class="dark-support rounded img-fit" alt="">
            ...
            @if($shop['id'] != 0 && $shop->bottom_banner)
                <div class="">
                    <img src="{{asset('public/storage/app/public/shop/banner')}}/{{$shop->bottom_banner}}" class="dark-support rounded img-fit"
            ...
            @elseif($shop['id'] == 0)
                ...
                @if($bottom_banner)
                <div class="">
                    <img src="{{asset('public/storage/app/public/shop')}}/{{$bottom_banner ?? ""}}" class="dark-support rounded img-fit"
                         onerror="this.src='{{theme_asset('assets/img/image-place-holder-4:1.png')}}'"
                         alt="">
                </div>
                @endif
