                                                    ...
                                                    <div
                                                        ...
                                                        <div class="avatar rounded-circle ">
                                                            <img
                                                                ...
                                                                src="{{ $shop->delivery_man_id ?asset('storage/delivery-man/'.$shop->image) : asset('public/storage/shop/'.$shop->image)}}"
                                                                loading="lazy"
                                    ...
                                    <div class="border-bottom px-3 py-2">
                                        <div class="media gap-2 align-items-center">
                                            <div class="avatar rounded-circle">
                                                <img
                                                    onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                    src="{{ $last_chat->delivery_man ?asset('storage/delivery-man/'.$last_chat->delivery_man->image) : asset('public/storage/shop/'.$last_chat->shop->image)}}"
