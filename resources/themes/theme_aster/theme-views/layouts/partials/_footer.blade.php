    ...
    <div class="footer-main px-2  px-lg-0">
        <div class="container">
            <div class="row gy-5">
                ...
                <div class="col-lg-12">
                    <div class="row gy-5 justify-content-around">
                        ...
                        <div class="col-sm-3 col-3 w-auto">
                            <div class="widget widget--nav absolute-white">
                        ...
                        <div class="col-sm-3 col-3 ">
                            <div class="widget widget--about text-center text-lg-start absolute-white d-flex flex-column align-items-center">
                                <img class="mb-3" width="180" src="{{asset("public/storage/company/")}}/{{ $web_config['footer_logo']->value }}"
            ...
            <div class="row gy-5 mt-4">
                ...
                <div class="d-flex gap-3 justify-content-center justify-content-lg-start flex-wrap mt-4 col-lg-4">
                ...
                <div class="d-flex gap-3 justify-content-center justify-content-lg-start flex-wrap mt-4 col-lg-4">
                    ...
                    <div class="media gap-3 absolute-white">
                        ...
                        <div class="media-body">
                            ...
                            <a class="absolute-white m-2" href="mailto:{{$web_config['email']->value}}">{{$web_config['email']->value}}</a>
