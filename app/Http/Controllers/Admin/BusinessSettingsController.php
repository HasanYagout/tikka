...
class BusinessSettingsController extends Controller
{
    ...
    {
        return view('admin.business-settings.general-settings');
    }

    public function about_us()
    {
        $about_us = BusinessSetting::where('type', 'about_us')->first();
        return view('admin.business-settings.about-us', [
            'about_us' => $about_us,
        ]);
    ...
    {
        // $about_us = BusinessSetting::where('type', 'about_us')->first();
        return view('admin.business-settings.social-media');
    }
    ...
    public function page($page)
    {
        ...
        if(in_array($page, $pages)){
            ...
            return view('admin.business-settings.page', compact('page', 'data'));
        }
    ...
    public function terms_condition()
    {
        ...
        return view('admin.business-settings.terms-condition', compact('terms_condition'));
    }
    ...
    public function privacy_policy()
    {
        ...
        return view('admin.business-settings.privacy-policy', compact('privacy_policy'));
    }
    ...
    public function productSettings()
    {
        ...
        $company_email = BusinessSetting::where('type', 'company_email')->first();
        $company_phone = BusinessSetting::where('type', 'company_phone')->first();
        $digital_product = \App\Models\BusinessSetting::where('type','digital_product')->first()->value;
        $brand = \App\Models\BusinessSetting::where('type','product_brand')->first()->value;

        return view('admin.business-settings.product-settings', compact('company_name','company_email','company_phone','digital_product','brand'));
    }
    ...
    public function announcement()
    {
        ...
        return view('admin.business-settings.website-announcement', compact('announcement'));
    }
    ...
    {
        return view('admin.business-settings.apps-settings');
    }
    ...
    {
        return view('admin.business-settings.fcm-index');
    }
    ...
    public function seller_settings()
    {
        ...
        return view('admin.business-settings.seller-settings');
    }
    ...
    {
        return view('admin.business-settings.social-login.view');
    }
    ...
    {
        return view('admin.business-settings.recaptcha-index');
    }
    ...
    {
        return view('admin.business-settings.map-api.index');
    }
    ...
    {
        return view('admin.business-settings.analytics.index');
    }
    ...
    public function cookie_settings(Request $request){
        ...
        return view('admin.business-settings.cookie-settings', compact('data'));
    }
    ...
    public function all_pages_banner(Request $request)
    {
        ...
        return view('admin.business-settings.all-page-banner', compact('page_banners', 'search'));
    }
    ...
    public function all_pages_banner_edit($id)
    {
        ...
        return view('admin.business-settings.all-page-banner-edit', compact('banner'));
    }
    ...
    public function otp_setup()
    {
        ...
        return view('admin.business-settings.otp-setup', compact('maximum_otp_hit', 'otp_resend_time',
    ...
    public function features_section()
    {
        ...
        return view('admin.business-settings.features-section.view', compact('features_section_top','features_section_middle','features_section_bottom'));
    }
