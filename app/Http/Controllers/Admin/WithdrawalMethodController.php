...
class WithdrawalMethodController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('admin.seller.withdraw-methods-list', compact('withdrawal_methods', 'search'));
    }

    public function create(Request $request)
    {
        return view('admin.seller.withdraw-methods-create');
    }
    ...
    public function edit($id)
    {
        ...
        return View('admin.seller.withdraw-methods-edit', compact('withdrawal_method'));
    }
