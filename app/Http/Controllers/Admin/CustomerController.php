...
class CustomerController extends Controller
{
    ...
    public function view(Request $request, $id)
    {
        ...
        if (isset($customer)) {
            ...
            return view('admin.customer.customer-view', compact('customer', 'orders', 'search'));
        }
    ...
    public function subscriber_list(Request $request)
    {
        ...
        return view('admin.customer.subscriber-list',compact('subscription_list','search'));
    }
    ...
    public function customer_settings()
    {
        ...
        return view('admin.customer.customer-settings', compact('data'));
    }
