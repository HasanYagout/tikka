...
class ReportController extends Controller
{
    public function admin_earning(Request $request)
    {
        ...
        return view('admin.report.admin-earning', compact('earning_data', 'inhouse_earn', 'shipping_earn',
    ...
    public function admin_earning_duration_download_pdf(Request $request){
        ...
        $mpdf_view = View::make('admin.report.admin-earning-duration-wise-pdf', compact('earning_data', 'company_name','company_email','company_phone','company_web_logo'));
    ...
    public function seller_earning(Request $request)
    {
        ...
        return view('admin.report.seller-earning', compact('data', 'payment_data', 'table_earning', 'total_earning', 'chart_earning_statistics', 'from', 'to', 'date_type'));
    }
