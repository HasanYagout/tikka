...
class ShippingMethodController extends Controller
{
    public function index_admin()
    {
        ...
        return view('admin.shipping-method.add-new', compact('shipping_methods'));
    }
    ...
    public function edit($id)
    {
        if ($id != 1) {
            ...
            return view('admin.shipping-method.edit', compact('method'));
        }
        return back();
    }
    ...
    public function setting()
    {
        ...
        return view('admin.shipping-method.setting',compact('all_category_shipping_cost','shipping_methods'));
    }
