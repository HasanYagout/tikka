...
class BrandController extends Controller
{
    public function add_new()
    {
        ...
        $language=\App\Models\BusinessSetting::where('type','pnc_language')->first();
        $language = $language->value ?? null;
        $default_lang = 'en';

        return view('admin.brand.add-new', compact('br', 'language', 'default_lang'));
    }
    ...
    function list(Request $request)
    {
        ...
        return view('admin.brand.list', compact('br','search'));
    }
