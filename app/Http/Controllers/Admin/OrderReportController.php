...
class OrderReportController extends Controller
{
    public function order_list(Request $request)
    {
        ...
        return view('admin.report.order-index', compact('orders', 'order_count', 'payment_data', 'chart_data', 'due_amount', 'settled_amount', 'sellers', 'seller_id', 'search', 'date_type', 'from', 'to'));
    }
