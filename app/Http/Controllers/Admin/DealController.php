...
class DealController extends Controller
{
    public function flash_index(Request $request)
    {
        ...
        return view('admin.deal.flash-index', compact('flash_deal', 'search'));
    }
    ...
    public function edit($deal_id)
    {
        ...
        return view('admin.deal.flash-update', compact('deal'));
    }

    public function feature_edit($deal_id)
    {
        $deal = FlashDeal::withoutGlobalScope('translate')->find($deal_id);
        return view('admin.deal.feature-update', compact('deal'));
    }
    ...
    public function feature_index(Request $request)
    {
        ...
        return view('admin.deal.feature-index', compact('flash_deals', 'search'));
    }
    ...
    public function add_product($deal_id)
    {
        ...
        return view('admin.deal.add-product', compact('deal', 'products','flash_deal_products'));
    }
    ...
    public function deal_of_day(Request $request)
    {
        ...
        return view('admin.deal.day-index', compact('deals', 'search'));
    }
    ...
    public function day_edit($deal_id)
    {
        ...
        return view('admin.deal.day-update', compact('deal'));
    }
