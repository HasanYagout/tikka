...
class LanguageController extends Controller
{
    ...
    {
        return view('admin.business-settings.language.index');
    }

    public function index_app()
    {
        return view('admin.business-settings.language.index-app');
    }
    ...
    public function translate($lang)
    {
        ...
        ksort($full_data);
        return view('admin.business-settings.language.translate', compact('lang', 'full_data'));
    }
