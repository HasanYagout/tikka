...
class ProductController extends BaseController
{
    public function add_new()
    {
        ...
        return view('admin.product.add-new', compact('cat', 'br', 'brand_setting', 'digital_product_setting'));
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.product.view', compact('product', 'reviews'));
    }
...
//            'digital_file_ready'   => 'required_if:digital_product_type,==,ready_product|mimes:jpg,jpeg,png,gif,zip,pdf',
    ...
    public function updated_product_list(Request $request)
    {
        ...
        return view('admin.product.updated-product-list', compact('pro', 'search'));
    }
    ...
    public function stock_limit_list(Request $request, $type)
    {
        ...
        $pro = $pro->orderBy('id', 'DESC')->paginate(Helpers::pagination_limit())->appends(['status' => $request['status']])->appends($query_param);
        return view('admin.product.stock-limit-list', compact('pro', 'search', 'request_status', 'sort_oqrderQty', 'stock_limit'));
    }
    ...
    public function get_variations(Request $request)
    {
        $product = Product::find($request['id']);
        return response()->json([
            'view' => view('admin.product.partials._update_stock', compact('product'))->render()
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.product.edit', compact('categories', 'br', 'product', 'product_category','brand_setting','digital_product_setting'));
    }
    ...
    public function barcode(Request $request, $id)
    {
        ...
        return view('admin.product.barcode', compact('product', 'limit'));
    }
