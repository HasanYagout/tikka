...
class OrderController extends Controller
{
    ...
    public function details($id)
    {
        ...
        {
            return view('admin.order.order-details', compact('shipping_address','order', 'linked_orders', 'delivery_men', 'total_delivered', 'company_name', 'company_web_logo', 'physical_product'));
        }else{
            return view('admin.pos.order.order-details', compact('order', 'company_name', 'company_web_logo'));
        }
