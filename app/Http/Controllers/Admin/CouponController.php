...
class CouponController extends Controller
{
    public function add_new(Request $request)
    {
        ...
        return view('admin.coupon.add-new', compact('cou', 'customers', 'sellers', 'search'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.coupon.edit', compact('c', 'customers', 'sellers'));
    }
    ...
    public function quick_view_details(Request $request)
    {
        ...
        return response()->json([
            'view' => view('admin.coupon.details-quick-view', compact('coupon'))->render(),
        ]);
    }
