...
class DeliveryManController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.delivery-man.index', compact('telephone_codes'));
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('admin.delivery-man.list', compact('delivery_men', 'search'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return response()->json([
            'view' => view('admin.delivery-man.partials._table', compact('delivery_men'))->render()
        ]);
    }
    ...
    public function preview($id)
    {
        ...
        return view('admin.delivery-man.view', compact('dm'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.delivery-man.edit', compact('delivery_man', 'telephone_codes'));
    }
    ...
    public function earning_statement_overview(Request $request, $id)
    {
        ...
        return view('admin.delivery-man.earning-statement.overview', compact('delivery_man', 'withdrawbale_balance'));
    }
    ...
    public function order_history_log(Request $request, $id)
    {
        ...
        return view('admin.delivery-man.earning-statement.active-log', compact('delivery_man', 'orders', 'search'));
    }
    ...
    public function order_wise_earning(Request $request, $id)
    {
        ...
        return view('admin.delivery-man.earning-statement.earning', compact('delivery_man', 'total_earn', 'withdrawable_balance', 'orders', 'search'));
    }
    ...
    public function ajax_order_status_history($order)
    {
        $histories = OrderStatusHistory::where(['order_id' => $order])
            ->latest()
            ->get();
        return view('admin.delivery-man.earning-statement._order-status-history', compact('histories'));
    }
    ...
    public function rating(Request $request, $id)
    {
        ...
        return view('admin.delivery-man.rating', compact('delivery_man', 'average_setting', 'reviews', 'total', 'one', 'two', 'three', 'four', 'five', 'from_date', 'to_date', 'rating', 'search'));
    }
