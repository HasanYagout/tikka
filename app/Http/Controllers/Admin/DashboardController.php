...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        return view('admin.system.dashboard', compact('data', 'inhouse_data', 'seller_data', 'commission_data'));
    }
    ...
    public function order_stats(Request $request)
    {
        ...
        return response()->json([
            'view' => view('admin.partials._dashboard-order-stats', compact('data'))->render()
        ], 200);
    }
