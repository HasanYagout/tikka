...
class ThemeController extends Controller
{
    ...
    public function theme_index()
    {
        ...
        return view('admin.business-settings.theme-setup', compact('themes'));
    }
    ...
    public function publish(Request $request)
    {
        ...
        if ($request['theme'] != 'default' && (empty($theme_info['purchase_code']) || empty($theme_info['username']) || $theme_info['is_active'] == '0')) {
            ...
            return response()->json([
                'flag' => 'inactive',
                'view' => view('admin.business-settings.partials.theme-activate-modal-data', compact('theme_info', 'theme'))->render(),
            ]);
        }
