...
class SellerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.seller.index', compact('sellers', 'search', 'current_date'));
    }
    ...
    public function view(Request $request, $id, $tab = null)
    {
        ...
        if ($tab == 'order') {
            ...
            return view('admin.seller.view.order', compact('seller', 'orders'));
        } else if ($tab == 'product') {
            $products = Product::where('added_by', 'seller')->where('user_id', $seller->id)->latest()->paginate(Helpers::pagination_limit());
            return view('admin.seller.view.product', compact('seller', 'products'));
        } else if ($tab == 'setting') {
            ...
            //return back();
            return view('admin.seller.view.setting', compact('seller'));
            ...
            return view('admin.seller.view.transaction', compact('seller', 'transactions','search','status'));
            ...
            return view('admin.seller.view.review', compact('seller', 'reviews', 'search'));
        }
        return view('admin.seller.view', compact('seller','current_date'));
    }
    ...
    public function order_list($seller_id)
    {
        ...
        return view('admin.seller.order-list', compact('orders', 'seller'));
    }
    ...
    public function product_list($seller_id)
    {
        ...
        $seller = Seller::findOrFail($seller_id);
        return view('admin.seller.porduct-list', compact('product', 'seller'));
    }
    ...
    public function order_details($order_id, $seller_id)
    {
        ...
        return view('admin.seller.order-details', compact('order', 'seller_id','delivery_men'));
    }
    ...
    public function withdraw()
    {
        ...
        return view('admin.seller.withdraw', compact('withdraw_req'));
    }
    ...
    public function withdraw_view($withdraw_id, $seller_id)
    {
        ...
        return view('admin.seller.withdraw-view', compact('withdraw_request', 'withdrawal_method'));
    }
    ...
    {
        return view('admin.seller.add-new-seller');
    }
}
