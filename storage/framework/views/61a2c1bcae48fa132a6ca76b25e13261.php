...
<main id="content" role="main" class="main">
    <div class="position-fixed top-0 right-0 left-0 bg-img-hero __inline-1"
         style="background-image: url(<?php echo e(asset('admin')); ?>/svg/components/abstract-bg-4.svg);">
        <!-- SVG Bottom Shape -->
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-6 input-icons" class="bg-white rounded">
                                        <a onclick="javascript:re_captcha();">
                                            <img src="<?php echo e(URL('/admin/auth/code/captcha/1')); ?>" class="input-field w-90 h-75" id="default_recaptcha_id">
...
<?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>