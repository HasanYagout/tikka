    ...
    <div class="card h-100 d-flex justify-content-center align-items-center">
        <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
            ...
            <div class="text-capitalize mb-30">
                <?php echo e(\App\CPU\translate('in-house_earning')); ?>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0"><?php echo e(\App\CPU\translate('commission_earned')); ?></div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0"><?php echo e(\App\CPU\translate('delivery_charge_earned')); ?></div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0"><?php echo e(\App\CPU\translate('total_tax_collected')); ?></div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0"><?php echo e(\App\CPU\translate('pending_amount')); ?></div>
                    </div>
                    <div>
...
<?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/partials/_dashboard-wallet-stats.blade.php ENDPATH**/ ?>