...
<div class="coupon__details">
    <div class="coupon__details-left">
        <div class="text-center">
            ...
            <h6 class="subtitle"><?php echo e(\App\CPU\translate('code')); ?> : <span id="coupon_code"><?php echo e($coupon->code); ?></span></h6>
            <div class="text-capitalize">
                <span><?php echo e(\App\CPU\translate(str_replace('_',' ',$coupon->coupon_type))); ?></span>
            </div>
        </div>
        <div class="coupon-info">
            <div class="coupon-info-item">
                <span><?php echo e(\App\CPU\translate('minimum_purchase')); ?> :</span>
            ...
            <div class="coupon-info-item" id="max_discount_modal_div">
                <span><?php echo e(\App\CPU\translate('maximum_discount')); ?> : </span>
            ...
            <?php endif; ?>
            <div class="coupon-info-item">
                <span><?php echo e(\App\CPU\translate('start_date')); ?> : </span>
                <span id="start_date"><?php echo e(\Carbon\Carbon::parse($coupon->start_date)->format('dS M Y')); ?></span>
            </div>
            <div class="coupon-info-item">
                <span><?php echo e(\App\CPU\translate('expire_date')); ?> : </span>
                <span id="expire_date"><?php echo e(\Carbon\Carbon::parse($coupon->expire_date)->format('dS M Y')); ?></span>
            </div>
            <div class="coupon-info-item">
                <span><?php echo e(\App\CPU\translate('discount_bearer')); ?> : </span>
                <span id="expire_date"><?php echo e(\App\CPU\translate($coupon->coupon_bearer == 'inhouse' ? 'admin' : $coupon->coupon_bearer)); ?></span>
            </div>
        </div>
    </div>
    <div class="coupon__details-right">
        <div class="coupon">
            ...
            <?php else: ?>
                ...
                <span><?php echo e(\App\CPU\translate('off')); ?></span>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/coupon/details-quick-view.blade.php ENDPATH**/ ?>