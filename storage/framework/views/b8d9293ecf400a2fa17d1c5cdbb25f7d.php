...
<!-- Single Product -->
<div class="product d-flex flex-column gap-10" onclick="location.href='<?php echo e(route('product',$product->slug)); ?>'">
    <!-- Product top -->
    <div class="product__top border rounded">
        ...
        <div class="product__actions d-flex flex-column gap-2">
            ...
            <a href="javascript:" onclick="quickView('<?php echo e($product->id); ?>', '<?php echo e(route('quick-view')); ?>')"
               class="btn-quickview stopPropagation" title="<?php echo e(translate('quick_view')); ?>">
                <i class="bi bi-eye"></i>
            </a>
        </div>
    ...
    <div class="product__summary d-flex flex-column gap-1 cursor-pointer">
        <div class="d-flex gap-2 align-items-center">
            <div class="star-rating text-gold fs-12">
                <?php for($i = 1; $i <= 5; $i++): ?>
                    ...
                    <?php elseif($overallRating[0] != 0 && $i <= (int)$overallRating[0] + 1.1): ?>
        ...
        <h6 class="product__title text-truncate" style="--width: 80%">
            <?php echo e(\Illuminate\Support\Str::limit($product['name'], 18)); ?>
...
<?php /**PATH C:\xampp\htdocs\tikka\resources\themes\theme_aster/theme-views/partials/_product-medium-card.blade.php ENDPATH**/ ?>