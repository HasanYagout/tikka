            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="<?php echo e(route('admin.dashboard.index')); ?>" aria-label="">
                    ...
                    <img class="navbar-brand-logo-mini"
                         onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                         src="<?php echo e(asset("public/storage/company/$e_commerce_logo")); ?>"
                         alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
                        ...
                        <div class="hs-unfold">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar border avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('public/storage/admin')); ?>/<?php echo e(auth('admin')->user()->image); ?>"
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    title: '<?php echo e(\App\CPU\translate('Do_you_want_to_logout')); ?>?',
                                    showDenyButton: true,
