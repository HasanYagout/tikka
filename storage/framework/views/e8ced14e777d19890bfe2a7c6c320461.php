    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                <?php echo e(\App\CPU\translate('Sub')); ?> <?php echo e(\App\CPU\translate('Category')); ?> <?php echo e(\App\CPU\translate('Setup')); ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-group <?php echo e($lang != $default_lang ? 'd-none':''); ?> lang_form"
                                            ...
                                            <label class="title-color"
                                                   for="exampleFormControlInput1"><?php echo e(\App\CPU\translate('sub_category')); ?> <?php echo e(\App\CPU\translate('name')); ?><span class="text-danger">*</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="exampleFormControlSelect1" name="parent_id"
                                            ...
                                            <option value="" selected disabled><?php echo e(\App\CPU\translate('Select_main_category')); ?></option>
                                    ...
                                    <div class="from_part_2">
                                        <label class="title-color"><?php echo e(\App\CPU\translate('sub_category_Logo')); ?></label>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="text-capitalize d-flex gap-2">
                                    <?php echo e(\App\CPU\translate('sub_category_list')); ?>
                        ...
                        <table style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo e(\App\CPU\translate('sub_category')); ?> <?php echo e(\App\CPU\translate('Image')); ?></th>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/category/sub-category-view.blade.php ENDPATH**/ ?>