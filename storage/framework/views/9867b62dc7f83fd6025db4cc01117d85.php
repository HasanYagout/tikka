<?php $__env->startSection('title', \App\CPU\translate('general_settings')); ?>
            ...
            <div class="card-body">
                <div class="border rounded border-color-c1 px-4 py-3 d-flex justify-content-between mb-1">
                    ...
                    <h5 class="mb-0 d-flex gap-1 c1">
                        ...
                        <?php echo e(\App\CPU\translate('maintenance_mode')); ?>
                ...
                <p>*<?php echo e(\App\CPU\translate('By_turning_on_maintaince_mode,_all_your_app_and_customer_side_website_will_be_off._Only_admin_panel_and_seller_panel_will_be_functional')); ?></p>
            </div>
        </div>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize d-flex gap-1">
                        ...
                        <?php echo e(\App\CPU\translate('Company_Information')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex"><?php echo e(\App\CPU\translate('company')); ?> <?php echo e(\App\CPU\translate('name')); ?></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(\App\CPU\translate('Phone')); ?></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex"><?php echo e(\App\CPU\translate('Email')); ?></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(\App\CPU\translate('company_address')); ?></label>
                                <input type="text" value="<?php echo e(isset($shop_address)!=null?$shop_address:''); ?>"
                                    name="shop_address" class="form-control"
                                    placeholder="<?php echo e(\App\CPU\translate('Your_shop_address')); ?>"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex"><?php echo e(\App\CPU\translate('latitude')); ?></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex"><?php echo e(\App\CPU\translate('longitude')); ?></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(\App\CPU\translate('time')); ?> <?php echo e(\App\CPU\translate('zone')); ?></label>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize d-flex gap-1">
                        ...
                        <?php echo e(\App\CPU\translate('business_Information')); ?>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <label class="title-color d-flex"><?php echo e(\App\CPU\translate('Currency')); ?> <?php echo e(\App\CPU\translate('Position')); ?></label>
                            <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(\App\CPU\translate('forgot_password_verification_by')); ?> </label>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1"><?php echo e(\App\CPU\translate('OTP_verification')); ?><span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1"><?php echo e(\App\CPU\translate('email')); ?> <?php echo e(\App\CPU\translate('verification')); ?><span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1"><?php echo e(\App\CPU\translate('order_verification')); ?><span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(\App\CPU\translate('Company_Copyright_Text')); ?></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex"><?php echo e(\App\CPU\translate('pagination')); ?> <?php echo e(\App\CPU\translate('settings')); ?></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label text-capitalize"><?php echo e(\App\CPU\translate('digit_after_decimal_point')); ?>(<?php echo e(\App\CPU\translate(' ex: 0.00')); ?>)</label>
                                <input type="number" value="<?php echo e($decimal_point->value); ?>"
                                       name="decimal_point_settings" class="form-control" min="0" placeholder="<?php echo e(\App\CPU\translate('4')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2">
                                ...
                                <?php echo e(\App\CPU\translate('Website_Color')); ?>
                        ...
                        <div class="card-body d-flex flex-wrap gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3"><?php echo e(strtoupper($data->primary)); ?></div>
                                    <label class="title-color text-capitalize"><?php echo e(\App\CPU\translate('Primary_Color')); ?></label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3"><?php echo e(strtoupper($data->secondary)); ?></div>
                                    <label class="title-color text-capitalize">
                                        <?php echo e(\App\CPU\translate('Secondary Color')); ?>
                            ...
                            <div class="form-group">
                                <input type="color" name="primary_light" value="<?php echo e(isset($data->primary_light) ? $data->primary_light : '#CFDFFB'); ?>"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">#CFDFFB</div>
                                    <label class="title-color text-capitalize"><?php echo e(\App\CPU\translate('Primary_Light_Color')); ?></label>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerWL"
                                        ...
                                        src="<?php echo e(asset('public/storage/company')); ?>/<?php echo e(\App\Models\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0]); ?>">
                            </center>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                ...
                                <?php echo e(\App\CPU\translate('Website_Footer_Logo')); ?>

                            </h5>
                            <span class="badge badge-soft-info">( <?php echo e(\App\CPU\translate('250x60 px')); ?>)</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerWFL"
                                    onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                    src="<?php echo e(asset('public/storage/company')); ?>/<?php echo e(\App\Models\BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0]); ?>">
                            </center>
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="<?php echo e(asset('public/assets/back-end/img/footer-logo.png')); ?>" alt="">
                                <?php echo e(\App\CPU\translate('Website Favicon')); ?>

                            </h5>
                            <span class="badge badge-soft-info">( <?php echo e(\App\CPU\translate('ratio 1:1 ')); ?>)</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFI"
                                        onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                        src="<?php echo e(asset('public/storage/company')); ?>/<?php echo e(\App\Models\BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0]); ?>">
                            </center>
                            <div class="position-relative mt-4">
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="<?php echo e(asset('public/assets/back-end/img/footer-logo.png')); ?>" alt="">
                                <?php echo e(\App\CPU\translate('Loading Gif')); ?>
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="<?php echo e(asset('public/assets/back-end/img/footer-logo.png')); ?>" alt="">
                                <?php echo e(\App\CPU\translate('App_Logo')); ?>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerML"
                                        onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                        src="<?php echo e(asset('public/storage/company')); ?>/<?php echo e(\App\Models\BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0]); ?>">
                            </center>
                            <div class="mt-4 position-relative">
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/business-settings/website-info.blade.php ENDPATH**/ ?>