...
<div class="product border rounded text-center d-flex flex-column gap-10" onclick="location.href='<?php echo e(route('product',$product->slug)); ?>'">
    <!-- Product top -->
    <div class="product__top" style="--width: 100%; --height: 12.5rem">
        ...
        <div class="product__actions d-flex flex-column gap-2">
            <a href="javascript:" onclick="addWishlist('<?php echo e($product['id']); ?>','<?php echo e(route('store-wishlist')); ?>')" id="wishlist-<?php echo e($product['id']); ?>"
            class="btn-wishlist stopPropagation add_to_wishlist wishlist-<?php echo e($product['id']); ?> <?php echo e(($wishlist == 1?'wishlist_icon_active':'')); ?>" title="Add to wishlist">
                <i class="bi bi-heart"></i>
            </a>
            <a href="javascript:" class="btn-compare stopPropagation add_to_compare compare_list-<?php echo e($product['id']); ?> <?php echo e(($compare_list == 1?'compare_list_icon_active':'')); ?>" title="<?php echo e(translate('add_to_compare')); ?>" onclick="addCompareList('<?php echo e($product['id']); ?>','<?php echo e(route('store-compare-list')); ?>')" id="compare_list-<?php echo e($product['id']); ?>">
                <i class="bi bi-repeat"></i>
            </a>
            <a href="javascript:" class="btn-quickview stopPropagation" onclick="location.href='<?php echo e(route('product',$product->slug)); ?>'" title="Quick View"
              >
                <i class="bi bi-eye"></i>
            </a>
        </div>
...
<?php /**PATH C:\xampp\htdocs\tikka\resources\themes\theme_aster/theme-views/partials/_similar-product-large-card.blade.php ENDPATH**/ ?>