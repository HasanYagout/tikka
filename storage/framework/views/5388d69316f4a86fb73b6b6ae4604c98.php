<?php $__env->startSection('title', \App\CPU\translate('POS')); ?>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="card">
                        <h5 class="p-3 m-0 "><?php echo e(\App\CPU\translate('Product_Section')); ?></h5>
                        <div class="px-3 py-4">
                            <div class="row gy-1">
                                <div class="col-sm-6">
                                    <div class="input-group d-flex justify-content-end" >
                                        <select name="category" id="category" class="form-control js-select2-custom w-100" title="select category" onchange="set_category_filter(this.value)">
                                            <option value=""><?php echo e(\App\CPU\translate('All Categories')); ?></option>
                                    ...
                                    <form class="">
                                        ...
                                        <div class="input-group-overlay input-group-merge input-group-custom">
                                            ...
                                            <input id="search" autocomplete="off" type="text" value="<?php echo e($keyword?$keyword:''); ?>"
                                                    name="search" class="form-control search-bar-input" placeholder="<?php echo e(\App\CPU\translate('Search by Name')); ?>"
                        ...
                        <div class="card-body pt-2" id="items">
                            <div class="pos-item-wrap">
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('admin.pos._single_product',['product'=>$product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
				...
				<div class="col-lg-5 mb-5">
                    <div class="card billing-section-wrap">
                        <h5 class="p-3 m-0 "><?php echo e(\App\CPU\translate('Billing_Section')); ?></h5>
                        <div class="card-body">
                            ...
                            <div id="cart" class="pb-5">
                                <?php echo $__env->make('admin.pos._cart',['cart_id'=>$cart_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(\App\CPU\translate('Print Invoice')); ?></h5>
                    ...
                    <div class="col-md-12">
                        <center>
                            <input id="print_invoice" type="button" class="btn btn--primary non-printable" onclick="printDiv('printableArea')"
                                value="<?php echo e(\App\CPU\translate('proceed')); ?>, <?php echo e(\App\CPU\translate('if_thermal_printer_is_ready')); ?>"/>
                            <a href="<?php echo e(url()->previous()); ?>" class="btn btn-danger non-printable"><?php echo e(\App\CPU\translate('Back')); ?></a>
                        </center>
                        <hr class="non-printable">
                    </div>
                    <div class="row m-auto" id="printableArea">
                        <?php echo $__env->make('admin.pos.order.invoice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                        ...
                        <?php echo csrf_field(); ?>
                            <div class="row pl-2" >
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label" ><?php echo e(\App\CPU\translate('first_name')); ?> <span
                                                class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="f_name" class="form-control" value="<?php echo e(old('f_name')); ?>"  placeholder="<?php echo e(\App\CPU\translate('first_name')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label" ><?php echo e(\App\CPU\translate('last_name')); ?> <span
                                                class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="l_name" class="form-control" value="<?php echo e(old('l_name')); ?>"  placeholder="<?php echo e(\App\CPU\translate('last_name')); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row pl-2" >
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label" ><?php echo e(\App\CPU\translate('email')); ?><span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>"  placeholder="<?php echo e(\App\CPU\translate('Ex')); ?>: ex@example.com" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label" ><?php echo e(\App\CPU\translate('phone')); ?><span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>"  placeholder="<?php echo e(\App\CPU\translate('phone')); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row pl-2" >
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(\App\CPU\translate('country')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text"  name="country" class="form-control" value="<?php echo e(old('country')); ?>"  placeholder="<?php echo e(\App\CPU\translate('country')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(\App\CPU\translate('city')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text"  name="city" class="form-control" value="<?php echo e(old('city')); ?>"  placeholder="<?php echo e(\App\CPU\translate('city')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(\App\CPU\translate('zip_code')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text"  name="zip_code" class="form-control" value="<?php echo e(old('zip_code')); ?>"  placeholder="<?php echo e(\App\CPU\translate('zip_code')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(\App\CPU\translate('address')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text"  name="address" class="form-control" value="<?php echo e(old('address')); ?>"  placeholder="<?php echo e(\App\CPU\translate('address')); ?>" required>
                                    </div>
                                </div>
                            </div>

                        <hr>
                        <button type="submit" id="submit_new_customer" class="btn btn--primary"><?php echo e(\App\CPU\translate('submit')); ?></button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    function customer_change(val) {
        ...
        $.post({
                url: '<?php echo e(route('admin.pos.remove-discount')); ?>',
                data: {
...
<script>
    ...
    function clear_cart()
    {
        let url = "<?php echo e(route('admin.pos.clear-cart-ids')); ?>";
...
<script>
    ...
    function new_order()
    {
        let url = "<?php echo e(route('admin.pos.new-cart-id')); ?>";
        document.location.href=url;
    }
</script>
<script>
...
<script>
    ...
    function extra_discount()
    {
        ...
        if(discount > 0)
        {
            ...
            toastr.warning('<?php echo e(\App\CPU\translate('amount_can_not_be_negative_or_zero!')); ?>', {
                CloseButton: true,
                ProgressBar: true
            });
        }
...
<script>
    ...
    function store_key(key, value) {
        ...
        $.post({
            ...
            success: function (data) {
                toastr.success(key+' '+'<?php echo e(\App\CPU\translate('selected')); ?>!', {
                    CloseButton: true,
                    ProgressBar: true
                });
            },
    ...
    function addToCart(form_id = 'add-to-cart-form') {
        if (checkAddToCartValidity()) {
                ...
                success: function (data) {
                    ...
                    if (data.data == 1) {
                        Swal.fire({
                            icon: 'info',
                            title: 'Cart',
                            text: '<?php echo e(\App\CPU\translate("Product already added in cart")); ?>'
                        });
                        return false;
                    } else if (data.data == 0) {
                        Swal.fire({
                            icon: 'error',
                            title: 'Cart',
                            text: '<?php echo e(\App\CPU\translate("Sorry, product is out of stock.")); ?>'
                        });
                        return false;
                    }
                    $('.call-when-done').click();

                    toastr.success('<?php echo e(\App\CPU\translate("Item has been added in your cart!")); ?>', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                    $('#cart').empty().html(data.view);
            ...
            Swal.fire({
                type: 'info',
                title: 'Cart',
                text: '<?php echo e(\App\CPU\translate("Please choose all the options")); ?>'
            });
        }
    }
   ...
   $(function(){
    ...
    function updateQuantity(key,qty,e, variant=null){
        ...
        if(qty!==""){
            ...
            $.post('<?php echo e(route('admin.pos.updateQuantity')); ?>', {_token: '<?php echo e(csrf_token()); ?>', key: key, quantity:qty, variant:variant}, function (data) {
                ...
                if(data.qty_update==1){
                    toastr.success('<?php echo e(\App\CPU\translate('Product_quantity_updated!')); ?>', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                }
            ...
            $.post('<?php echo e(route('admin.pos.updateQuantity')); ?>', {_token: '<?php echo e(csrf_token()); ?>', key: key, quantity:minValue, variant:variant}, function (data) {
...
<!-- IE Support -->
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="<?php echo e(asset('admin')); ?>/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/pos/index.blade.php ENDPATH**/ ?>