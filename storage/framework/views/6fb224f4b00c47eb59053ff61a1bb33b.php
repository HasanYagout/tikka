...
<div class="navbar-tool dropdown <?php echo e(Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'); ?>"
    ...
    <a class="navbar-tool-text <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'); ?>" href="<?php echo e(route('shop-cart')); ?>"><small><?php echo e(\App\CPU\translate('my_cart')); ?></small>
    ...
    <!-- Cart dropdown-->
    <div class="dropdown-menu dropdown-menu-<?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?> __w-20rem ">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="widget-product-title">
                                        <a href="<?php echo e(route('product',$cartItem['slug'])); ?>"><?php echo e(Str::limit($cartItem['name'],30)); ?></a></h6>
                                    <?php $__currentLoopData = json_decode($cartItem['variations'],true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="__text-14px"><?php echo e($key); ?> : <?php echo e($variation); ?></span><br>
...
<?php /**PATH C:\xampp\htdocs\tikka\resources\themes\default/layouts/front-end/partials/cart.blade.php ENDPATH**/ ?>