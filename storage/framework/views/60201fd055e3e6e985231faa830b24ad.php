    ...
    <div class="content container-fluid">
        ...
        <div class="row" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        ...
                        <div class="row align-items-center">
                            <div class="col-10">
                                <button class="btn btn--primary" type="button" data-toggle="collapse"
                                    ...
                                    <?php echo e(\App\CPU\translate('test_your_email_integration')); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="form-group mb-2">
                                                <label for="inputPassword2"
                                                       class="sr-only"><?php echo e(\App\CPU\translate('mail')); ?></label>
                                        ...
                                        <div class="col-4">
                                            <button type="button" onclick="send_mail()" class="btn btn--primary mb-2 btn-block">
                                                <i class="tio-telegram"></i>
                                                <?php echo e(\App\CPU\translate('send_mail')); ?>
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0"><?php echo e(\App\CPU\translate('smtp_mail_config')); ?></h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.business-settings.mail.update')); ?>"
                            ...
                            <?php if(isset($data_smtp)): ?>
                                ...
                                <div class="form-group">
                                    <label class="title-color"><?php echo e(\App\CPU\translate('email_id')); ?></label><br>
                                ...
                                <div class="form-group">
                                    <label class="title-color"><?php echo e(\App\CPU\translate('Encryption')); ?></label><br>
                                ...
                                <div class="form-group">
                                    <label class="title-color"><?php echo e(\App\CPU\translate('password')); ?></label><br>
            ...
            <div class="col-sm-6">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0"><?php echo e(\App\CPU\translate('sendgrid_mail_config')); ?></h5>
                    </div>
                    <div class="card-body">
                        <?php ($data_sendgrid=\App\CPU\Helpers::get_business_settings('mail_config_sendgrid')); ?>
                        <form action="<?php echo e(route('admin.business-settings.mail.update-sendgrid')); ?>"
                              method="post">
                            <?php echo csrf_field(); ?>
                            <?php if(isset($data_sendgrid)): ?>
                            <label class="mb-3 d-block title-color"><?php echo e(\App\CPU\translate('sendgrid_mail')); ?></label>

                            <div class="d-flex gap-10 align-items-center mb-2">
                                <input type="radio" name="status"
                                        value="1" <?php echo e($data_sendgrid['status']==1?'checked':''); ?>>
                                <label class="title-color mb-0"><?php echo e(\App\CPU\translate('Active')); ?></label>
                            </div>
                            <div class="d-flex gap-10 align-items-center mb-4">
                                <input type="radio" name="status"
                                        value="0" <?php echo e($data_sendgrid['status']==0?'checked':''); ?>>
                                <label class="title-color mb-0"><?php echo e(\App\CPU\translate('Inactive')); ?></label>
                            </div>
                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('mailer_name')); ?></label>
                                <input type="text" placeholder="ex : Alex" class="form-control" name="name"
                                        value="<?php echo e(env('APP_MODE')=='demo'?'':$data_sendgrid['name']); ?>">
                            </div>

                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('Host')); ?></label>
                                <input type="text" class="form-control" name="host"
                                        value="<?php echo e(env('APP_MODE')=='demo'?'':$data_sendgrid['host']); ?>">
                            </div>
                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('Driver')); ?></label>
                                <input type="text" class="form-control" name="driver"
                                        value="<?php echo e(env('APP_MODE')=='demo'?'':$data_sendgrid['driver']); ?>">
                            </div>
                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('port')); ?></label>
                                <input type="text" class="form-control" name="port"
                                        value="<?php echo e(env('APP_MODE')=='demo'?'':$data_sendgrid['port']); ?>">
                            </div>

                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('Username')); ?></label>
                                <input type="text" placeholder="ex : ex@yahoo.com" class="form-control"
                                        name="username"
                            ...
                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('email_id')); ?></label>
                                <input type="text" placeholder="ex : ex@yahoo.com" class="form-control" name="email"
                                        value="<?php echo e(env('APP_MODE')=='demo'?'':$data_sendgrid['email_id']); ?>">
                            </div>

                            <div class="form-group">
                                <label class="title-color"><?php echo e(\App\CPU\translate('Encryption')); ?></label>
                                <input type="text" placeholder="ex : tls" class="form-control" name="encryption"
        ...
        function send_mail() {
            if (ValidateEmail($('#test-email').val())) {
                Swal.fire({
                    ...
                    text: "<?php echo e(\App\CPU\translate('a_test_mail_will_be_sent_to_your_email')); ?>!",
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.success === 2) {
                                    toastr.error('<?php echo e(\App\CPU\translate('email_configuration_error')); ?> !!');
                                } else if (data.success === 1) {
                                    toastr.success('<?php echo e(\App\CPU\translate('email_configured_perfectly!')); ?>!');
                                } else {
                                    toastr.info('<?php echo e(\App\CPU\translate('email_status_is_not_active')); ?>!');
                                }
                            },
                            complete: function () {
                                $('#loading').hide();
                ...
                toastr.error('<?php echo e(\App\CPU\translate('invalid_email_address')); ?> !!');
            }
        }
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tikka\resources\views/admin/business-settings/mail/index.blade.php ENDPATH**/ ?>